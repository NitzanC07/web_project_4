...
export const profileFormPopup = document.querySelector(".popup_type_edit-profile");
export const profileFormPopupSelector = ".popup_type_edit-profile";
export const cardFormPopup = document.querySelector(".popup_type_add-card");
...
export const popupDescription = document.querySelector(".popup__input_content_description");
